...
import { 
    ...
    CloudArrowUpIcon, // Added for the upload date card
...
// Loader and other helper functions remain the same...
  ...
  return (
    <div className="p-4 sm:p-8 bg-slate-50 min-h-full">
      ...
      <div className="space-y-8">
        ...
        {/* --- UPDATED SESSION INFORMATION SECTION --- */}
        <div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            ...
            <StatCard icon={<CalendarIcon className="w-8 h-8" />} label="Run Date" value={runDate.toLocaleDateString()} />
            <StatCard icon={<CloudArrowUpIcon className="w-8 h-8" />} label="Upload Date" value={new Date(session.uploaded_at).toLocaleDateString()} />
